...
''')
print("✅ Created user table with mobile column")
...
''')
print("✅ Created crop_listing table")
...
''')
print("✅ Created disease_history table")

conn.commit()
conn.close()

print("\n" + "="*50)
print("✅ Database created successfully with mobile column!")
print("="*50)
print("\nTables created:")
